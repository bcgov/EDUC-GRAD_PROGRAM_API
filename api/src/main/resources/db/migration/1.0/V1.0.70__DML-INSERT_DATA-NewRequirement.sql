...
INSERT INTO PROGRAM_REQUIREMENT_CODE (PROGRAM_REQUIREMENT_CODE, LABEL, DESCRIPTION, DISPLAY_ORDER, ACTIVE_REQUIREMENT, LANGUAGE_OF_INSTRUCTION, NOT_MET_DESC, REQUIRED_CREDITS, REQUIREMENT_TYPE_CODE) VALUES('508', 'Student Grade AD', 'Adult students must be in grade AD', 508, 'Y', NULL, 'The school has not reported the student as being expected to graduate this year (subgrade must = AD)', '0', 'SG');
